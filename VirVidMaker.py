...
urlretrieve(
    'https://raw.githubusercontent.com/xemulat/VirusVideoMaker/main/texttofile.txt', 'temp.vvgen')
...
def getdata():
    ...
    custom = [[sg.Text("Version - " + vers, text_color=hcve)],
              ...
              [sg.Button('Exit'), sg.Button('Enter', visible=True,
                                            bind_return_key=True), sg.Button('Sample Video')],
              [sg.Text('')],
              [sg.Text('Coded by Xemulated')]]
